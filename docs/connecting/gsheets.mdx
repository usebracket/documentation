...
To sync Google Sheets using Bracket, there are two basic requirements:
    - The row headers must start at row 1
    - The sheet must have a primary field column that contains unique values. This can be as simple as an integer, or more complex like a UUIDV4
