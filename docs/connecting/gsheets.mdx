...
To sync Google Sheets using Bracket, there are two basic requirements:
    1. The row headers must start at row 1. There can be no extra rows above the table.
...
Share your spreadsheet with the Bracket Service Account by sharing access to this email address: bracket@central-run-344416.iam.gserviceaccount.com.
