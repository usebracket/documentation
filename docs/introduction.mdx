...
description: 'Bracket helps you set up fast two-way syncs between CRMs and databases.'
---

## The basics

Bracket enables you to set up flexible one-way or two-way syncs between CRMs and databases. Right now, we're focused on making Salesforce <> Postgres the best in the market, but we have several other integrations in development and beta.

Bracket is designed for engineers, but is simple enough to use without code.
...
3. **We're here to build something we're proud of.** Some companies see users as a path to an exit, but we see users as our sounding board for whether we're building something valuable. We're not just saying it: your honest feedback is invaluable to us.
