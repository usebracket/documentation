...
- Share your spreadsheet with the specific service account `bracket@central-run-344416.iam.gserviceaccount.com`.
...
- Collect and share the sheet name e.g. Sheet1
