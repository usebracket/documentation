...
<Tip>Note that if Postgres is your secondary source, you do not need to have a table created before setting up your sync - Bracket will do that for you.</Tip>
