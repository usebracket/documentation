...
|-------------------------------------------------|------------------------------------------------------|------------------------------------------------------|
| [Postgres](/connecting/postgres_connecting)     | Current app & legacy app                             | Live |
| [Salesforce](/connecting/salesforce_connecting) | Current app only                                     | Live |
| [Hubspot](/connecting/hubspot_connecting)       | Current app only                       | Live (public beta)
| [Airtable](/connecting/airtable_connecting)     | Current app & legacy app                             | Live |
| [Google Sheets](/connecting/gsheets_connecting) | Current app & legacy app               | Live |
| [MySQL](/connecting/mysql_connecting)           | Current app & legacy app               | Live (public beta) |
| [DynamoDB](/connecting/dynamodb_connecting)       | Current app & legacy app               | Live (public beta) |
| [MongoDB](/connecting/mongodb_connecting)       | Current app & legacy app               | Live (private beta, email eng@usebracket.com to request access) |
| [Firestore](/connecting/firebase_connecting)    | Legacy app only                                      | Live |
| [Snowflake](/connecting/snowflake_connecting)   | Legacy app only                                      | Live |
| [Notion](/connecting/notion_connecting)         | Legacy app only                                      | Live |
