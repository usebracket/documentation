...
<Card title="Get started here" icon="fa-duotone fa-rocket-launch" href="/quickstart">
...
| Data source                                  | Support                                                                                                                  |
| --------------------------------      | --------------------------------------------------------------------------------------------------------------------------------- |
| [Google Sheets](/connecting/gsheets_connecting)      |  Legacy app & current app                                                                                              |
| [Airtable](/connecting/airtable_connecting)      |  Legacy app & current app                                                                                              |
| [Notion](/connecting/notion_connecting)      |  Legacy app only & current app                                                                                           |
| [MySQL](/connecting/mysql_connecting)      |  Legacy app & current app                                                                                              |
| [MongoDB](/connecting/mongodb_connecting)      |  Legacy app & current app                                                                                              |
| [Firebase](/connecting/firebase_connecting)      |  Legacy app only                                                                                              |
