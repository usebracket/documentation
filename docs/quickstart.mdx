...
<Card title="Bracket Web App" icon={duotone("link")} href="/introduction">
...
<Note>If you need help setting up either side of the sync (e.g., you want to sync Airtable with Postgres but don't have Postgres set up yet), just ping us at eng@usebracket! We're happy to help with that setup.</Note>
